...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppItemBoardItemBoardComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function ItemBoardComponent_div_11_div_4_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](1, "app-item", 11);
    ...
    var ItemBoardComponent = /*#__PURE__*/function () {
      ...
      _createClass(ItemBoardComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.refresh(); // Listen to all changes

          this.$eventObservable = this.itemService.listenToEvents().subscribe(function (itemEvent) {
            _this2.handleEvent(itemEvent);
          });
        }
      }, {
        key: "ngOnDestroy",
        ...
        value: function refresh() {
          ...
          this.itemService.findAll().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["finalize"])(function () {
            ...
            _this3.statusItemsMap.get(item.status).push(item);
          });
        }
      }, {
        key: "getStatuses",
        ...
        value: function add() {
          ...
          dialogRef.afterClosed().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["take"])(1)).subscribe(function (response) {
            if (response) {
              _this4.itemService.addItem(response).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["finalize"])(function () {
                return _this4.stopActionInProgress();
              })).subscribe(function () {});
            } else {
        ...
        value: function drop(event) {
          ...
          if (event.previousContainer !== event.container) {
            ...
            this.itemService.updateStatus(item.id, item.version, newStatus).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["finalize"])(function () {
              return _this5.stopActionInProgress();
            })).subscribe(function () {});
          }
        }
      }, {
        ...
        key: "handleEvent",
        value: function handleEvent(eventWrapper) {
          var receivedEvent = eventWrapper.event;
          ...
          switch (eventWrapper.eventType) {
            ...
            case 'ItemSaved':
              var item = receivedEvent.item;
              this.removeItem(item.id); // Add it to the correct status column
    ...
    ItemBoardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      styles: [".toolbar[_ngcontent-%COMP%] {\n  border-bottom: black solid 0.5px;\n  margin-bottom: 50px;\n}\n\n.toolbar-title[_ngcontent-%COMP%] {\n  padding-top: 10px;\n  padding-left: 10px;\n  padding-right: 40px;\n  font-size: 1.5em;\n  font-family: \"Luckiest Guy\", cursive;\n  color: white;\n  text-shadow: 2px 2px black;\n}\n\n.toolbar-item[_ngcontent-%COMP%] {\n  margin-left: 10px;\n  margin-right: 10px;\n}\n\n.status-cols[_ngcontent-%COMP%] {\n  display: flex;\n  overflow: hidden;\n}\n\n.status-col[_ngcontent-%COMP%] {\n  float: left;\n  margin: 5px;\n  width: 33%;\n  min-height: 60vh;\n}\n\n.status-col.drag-drop-hover-col[_ngcontent-%COMP%] {\n  border: dashed darkred 1px;\n}\n\n.status-title[_ngcontent-%COMP%] {\n  font-family: \"Luckiest Guy\", cursive;\n  color: #ececec;\n  text-shadow: 2px 2px black;\n  text-align: center;\n  padding-top: 10px;\n  padding-bottom: 20px;\n  font-size: 30px;\n}\n\n.item-div[_ngcontent-%COMP%] {\n  margin: 20px;\n}\n\n.cdk-drag-placeholder[_ngcontent-%COMP%] {\n  visibility: hidden;\n}\n\n.cdk-drag-animating[_ngcontent-%COMP%] {\n  transition: transform 250ms cubic-bezier(0, 0, 0.2, 1);\n}\n/*# sourceMappingURL=data:application/json;base64, */"]
    });
    /*@__PURE__*/
  ...
  function srcAppItemSaveDialogItemSaveDialogComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    ItemSaveDialogComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      styles: [".mat-dialog-actions[_ngcontent-%COMP%] {\n  justify-content: flex-end;\n}\n\ntextarea[_ngcontent-%COMP%] {\n  resize: none;\n}\n/*# sourceMappingURL=data:application/json;base64, */"]
    });
    /*@__PURE__*/
  ...
  function srcAppItemItemComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ItemComponent = /*#__PURE__*/function () {
      ...
      _createClass(ItemComponent, [{
        ...
        value: function _delete() {
          ...
          this.actionInProgress = true;
          this.itemService["delete"](this.item.id, this.item.version).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["finalize"])(function () {
        ...
        value: function edit() {
          ...
          dialogRef.afterClosed().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["take"])(1)).subscribe(function (response) {
            if (response) {
              _this7.itemService.updateDescription(_this7.item.id, _this7.item.version, response).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["finalize"])(function () {
    ...
    ItemComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      styles: [".item-card[_ngcontent-%COMP%] {\n  padding: 15px;\n  background-color: lightyellow;\n  margin: 0;\n  overflow: auto;\n  min-height: 75px;\n  max-height: 200px;\n}\n\n.item-description[_ngcontent-%COMP%] {\n  padding-right: 20px;\n  padding-left: 5px;\n  word-break: break-all;\n  word-wrap: break-word;\n  white-space: pre-line;\n}\n\n.icon[_ngcontent-%COMP%] {\n  margin-top: 5px;\n  margin-bottom: 5px;\n  cursor: pointer;\n}\n\n.toolbar[_ngcontent-%COMP%] {\n  margin-left: 10px;\n}\n\n.fade[_ngcontent-%COMP%] {\n  -webkit-animation: fadeIn 0.5s linear;\n          animation: fadeIn 0.5s linear;\n}\n\n@-webkit-keyframes fadeIn {\n  0% {\n    opacity: 0;\n  }\n  100% {\n    opacity: 1;\n  }\n}\n\n@keyframes fadeIn {\n  0% {\n    opacity: 0;\n  }\n  100% {\n    opacity: 1;\n  }\n}\n\n.timestamp-info[_ngcontent-%COMP%] {\n  color: darkgrey;\n  padding-top: 2px;\n  text-align: right;\n  width: 100%;\n  font-size: 11px;\n  font-family: sans-serif;\n}\n\n.timestamp-info.recent[_ngcontent-%COMP%] {\n  color: darkgreen;\n}\n/*# sourceMappingURL=data:application/json;base64, */"]
    });
    /*@__PURE__*/
      ...
      _createClass(ItemService, [{
        ...
        value: function findAll() {
          ...
          return new rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"](function (observer) {
            _this8.handleMessageEvent(new EventSource(_this8.baseUrl), observer);
          });
        }
      }, {
        key: "listenToEvents",
        value: function listenToEvents() {
          ...
          return new rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"](function (observer) {
            _this9.handleMessageEvent(new EventSource("".concat(_this9.baseUrl, "/events")), observer, true);
          });
        }
      }, {
        key: "addItem",
        ...
        value: function _delete(id, version) {
          return this.http["delete"]("".concat(this.baseUrl, "/").concat(id), ItemService.buildOptionsIfMatch(version));
        }
      }, {
        ...
        value: function updateDescription(id, version, description) {
          return this.http.patch("".concat(this.baseUrl, "/").concat(id), {
            description: description
          }, ItemService.buildOptionsIfMatch(version));
        }
      }, {
        key: "updateStatus",
        ...
        value: function handleMessageEvent(eventSource, observer) {
          var _this10 = this;
        ...
        key: "buildOptionsIfMatch",
        value: function buildOptionsIfMatch(version) {
          return {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/ajacquot/Projects/ptl/reactive-todo-list/todo-list-ui/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
